...
class OPTAttention(nn.Module):
    ...
    def __init__(
        ...
        self.k_proj = HKLinear(embed_dim, embed_dim, self.num_heads, bias=bias)
        self.v_proj = HKLinear(embed_dim, embed_dim, self.num_heads, bias=bias)
        self.q_proj = HKLinear(embed_dim, embed_dim, self.num_heads, bias=bias)
        self.out_proj = HKLinear(embed_dim, embed_dim, self.num_heads, bias=bias)
...
class OPTDecoder(OPTPreTrainedModel):
    ...
    def __init__(self, config: OPTConfig):
        ...
        if config.word_embed_proj_dim != config.hidden_size:
            self.project_out = HKLinear(config.hidden_size, config.word_embed_proj_dim, config.num_attention_heads, bias=False)
        else:
            self.project_out = None

        if config.word_embed_proj_dim != config.hidden_size:
            self.project_in = HKLinear(config.word_embed_proj_dim, config.hidden_size, config.num_attention_heads, bias=False)
        else:
